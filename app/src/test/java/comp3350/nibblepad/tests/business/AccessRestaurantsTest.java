...
import comp3350.nibblepad.persistence.stubs.RestaurantPersistenceStub;

public class AccessRestaurantsTest extends TestCase {
    ...
    public void setUp() throws IOException {
        restaurantsAccessor = new AccessRestaurants(new RestaurantPersistenceStub());
